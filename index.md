...
#### Operations guide:
* quick [instructions](doc/quickstart.html) for building, installing and running DAOS
* [DAOS operations manual](https://wiki.hpdd.intel.com/display/DC/Operations+Manual)
* [testing](doc/testing.html) DAOS
* [debugging](doc/debugging.html) DAOS

#### User area:
* [Overview of the DAOS storage model](doc/storage_model.html)
* DAOS API
...
* [internals documentation](src/README.html)

More information can be found on the [wiki](https://wiki.hpdd.intel.com/display/DC/DAOS+Community+Home).

## Contacts

For any questions, please post to our [user forum](https://daos.groups.io/g/daos). Bugs should be reported through our [issue tracker](https://jira.hpdd.intel.com/projects/DAOS) with a test case to reproduce the issue (when applicable) and [debug logs](./doc/debugging.html).
