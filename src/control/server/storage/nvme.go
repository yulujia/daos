...
func (n *NvmeProvider) getController(pciAddr string) *pb.NvmeController {
...
// errors occurring before devices could be accessed. Otherwise a result will
// be populated for each device in bdev_list.
func (n *NvmeProvider) Update(cfg BdevConfig, req *pb.UpdateNvmeReq, results *(types.NvmeControllerResults)) {
	var pciAddr string
