...
The I/O server includes a dRPC server that listens for activity on a given Unix Domain Socket. See the [dRPC documentation](src/control/drpc/README.html) for more details on the basics of dRPC, and the low-level APIs in Golang and C.
